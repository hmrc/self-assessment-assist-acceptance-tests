@Auth @IndividualsBusinessEOPSApiV2Auth @IndividualsBusinessEOPSApi @IndividualsBusinessEOPSApiV2 @All

Feature: Test auth for amend individuals-business-eops-api on a single endpoint
  ...
  Scenario: Successful request - individual
    ...
    When a request is made to POST to url: BusinessEOPSUrl, with the JSON body: SubmitBusinessEOPSSelfEmploymentV2, and the gov-test-scenario: None
