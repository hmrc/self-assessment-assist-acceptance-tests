...
case class AdjustedSummaryCalculation(totalIncome: Option[BigDecimal],
...
object AdjustedSummaryCalculation {
  implicit val format: OFormat[AdjustedSummaryCalculation] = Json.format[AdjustedSummaryCalculation]
}
